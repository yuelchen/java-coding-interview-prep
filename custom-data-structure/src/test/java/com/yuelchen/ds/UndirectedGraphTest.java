...
public class UndirectedGraphTest {
	...
	@Before
	public void SetUp() {
		this.graph = new UndirectedGraph<String>();
	}
	...
	public void AddOneGetNodeExist() {
		...
		Assert.assertTrue(this.graph.getNode("A").containsDestination("B"));
		
		Assert.assertNotNull(this.graph.getNode("B"));
		Assert.assertTrue(this.graph.getNode("B").containsDestination("A"));
	}
	...
	public void AddSelf() {
		...
		Assert.assertTrue(this.graph.getNode("A").containsDestination("A"));
	}
	...
	public void AddMultiCombo() {
		...
		Assert.assertEquals(3, this.graph.getNode("A").getDestinationNodes().size());
		Assert.assertEquals(2, this.graph.getNode("B").getDestinationNodes().size());
		Assert.assertEquals(2, this.graph.getNode("C").getDestinationNodes().size());
	}
	...
	public void AddMultiComboNodeEdgeCountExist() {
		...
		Assert.assertEquals(3, this.graph.getNodeEdgeCount("A"));
		Assert.assertEquals(2, this.graph.getNodeEdgeCount("B"));
		Assert.assertEquals(2, this.graph.getNodeEdgeCount("C"));
	}
	...
	public void AddMultiComboContainsEdgeNotExist() {
		...
		Assert.assertFalse(this.graph.containsEdge("B", "B"));
	}
